...
// The first player in any player array is the goalkeeper and the others are field players. For Bayern Munich (team 1) create one variable ('gk') with the goalkeeper's name, and one array ('fieldPlayers') with all the remaining 10 field
...
printGoals("Davies", "Muller", "Lewandowski", "Kinmick"); // 4 pllayers scored
printGoals("Davies", "Muller"); //2 players scored
printGoals(...game.scored); //list the names of scorers
